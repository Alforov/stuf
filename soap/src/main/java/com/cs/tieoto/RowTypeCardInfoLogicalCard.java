...
@XmlType(name = "RowType_CardInfo_LogicalCard", namespace = "urn:issuing_v_01_02_xsd", propOrder = {
    "card",
    "client",
    "clrole",
    "cardtype",
...
public class RowTypeCardInfoLogicalCard {
    ...
    @XmlElementRef(name = "CL_ROLE", type = JAXBElement.class, required = false)
    protected JAXBElement<String> clrole;
    @XmlElementRef(name = "CARD_TYPE", type = JAXBElement.class, required = false)
    protected JAXBElement<String> cardtype;
    @XmlElement(name = "BASE_SUPP", required = true, nillable = true)
    ...
    @XmlElementRef(name = "USRID", type = JAXBElement.class, required = false)
    protected JAXBElement<String> usrid;
    @XmlElementRef(name = "CTIME", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> ctime;
    @XmlElementRef(name = "EFFECTIVE_DATE1", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> effectivedate1;
    ...
    @XmlElementRef(name = "NO_NAME", type = JAXBElement.class, required = false)
    protected JAXBElement<String> noname;
    @XmlElementRef(name = "RANGE_ID", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> rangeid;
     ...
     *     
     */
    public JAXBElement<String> getCLROLE() {
        return clrole;
    }
     ...
     *     
     */
    public void setCLROLE(JAXBElement<String> value) {
        this.clrole = value;
    }
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getCTIME() {
        return ctime;
    }
     ...
     *     
     */
    public void setCTIME(JAXBElement<XMLGregorianCalendar> value) {
        this.ctime = value;
    }
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getEFFECTIVEDATE1() {
     ...
     *     
     */
    public void setEFFECTIVEDATE1(JAXBElement<XMLGregorianCalendar> value) {
     ...
     *     
     */
    public JAXBElement<String> getNONAME() {
        return noname;
    }
     ...
     *     
     */
    public void setNONAME(JAXBElement<String> value) {
        this.noname = value;
    }
     ...
     *     
     */
    public JAXBElement<BigDecimal> getRANGEID() {
        return rangeid;
    }
     ...
     *     
     */
    public void setRANGEID(JAXBElement<BigDecimal> value) {
        this.rangeid = value;
    }
