...
@XmlType(name = "RowType_DormantAccountByCard_Request", namespace = "urn:issuing_v_01_02_xsd", propOrder = {
    "card",
    "dormantmode",
    "text",
    "bankc",
...
public class RowTypeDormantAccountByCardRequest {
    ...
    @XmlElement(name = "DORMANT_MODE", required = true, nillable = true)
    ...
    @XmlElement(name = "INSTL_INTER", required = true, nillable = true)
