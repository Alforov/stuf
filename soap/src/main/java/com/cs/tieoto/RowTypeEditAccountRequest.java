...
@XmlType(name = "RowType_EditAccount_Request", namespace = "urn:issuing_v_01_02_xsd", propOrder = {
    "accountno",
    "accprty",
    "caccnttype",
    "cardacct",
...
public class RowTypeEditAccountRequest {
    ...
    @XmlElementRef(name = "CREATED_DATE", type = JAXBElement.class, required = false)
