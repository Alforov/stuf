...
@XmlType(name = "RowType_EditAgreement_Request", namespace = "urn:issuing_v_01_02_xsd", propOrder = {
    "agrenom",
    "bincod",
    "bankcode",
    "branch",
...
public class RowTypeEditAgreementRequest {
    ...
    @XmlElementRef(name = "ENROLLED", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> enrolled;
     ...
     *     
     */
    public JAXBElement<XMLGregorianCalendar> getENROLLED() {
        return enrolled;
    }
     ...
     *     
     */
    public void setENROLLED(JAXBElement<XMLGregorianCalendar> value) {
        this.enrolled = value;
    }
