...
@XmlType(name = "RowType_TransferLoyaltyPoints", namespace = "urn:issuing_v_01_02_xsd", propOrder = {
    "lscode",
    "keytypesource",
    "keyvaluesource",
    "keytypetarget",
...
public class RowTypeTransferLoyaltyPoints {
    ...
    @XmlElement(name = "KEY_TYPE_SOURCE", required = true, nillable = true)
    protected BigDecimal keytypesource;
    @XmlElement(name = "KEY_VALUE_SOURCE", required = true, nillable = true)
    protected String keyvaluesource;
    @XmlElement(name = "KEY_TYPE_TARGET", required = true, nillable = true)
    protected BigDecimal keytypetarget;
    @XmlElement(name = "KEY_VALUE_TARGET", required = true, nillable = true)
